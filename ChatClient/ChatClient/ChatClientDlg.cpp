...
BEGIN_MESSAGE_MAP(CChatClientDlg, CDialogEx)
	...
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDC_BTN_SEND, &CChatClientDlg::OnClickedBtnSend)
	ON_MESSAGE(WM_CLIENT_RECV, &CChatClientDlg::OnClientRecv)
END_MESSAGE_MAP()
...
void CChatClientDlg::OnClickedBtnSend()
{
...
afx_msg LRESULT CChatClientDlg::OnClientRecv(WPARAM wParam, LPARAM lParam)
{
