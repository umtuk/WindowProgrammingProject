// BOOKS.h : CBOOKS의 선언입니다.

#pragma once

// 코드 생성 위치 2019년 6월 6일 목요일, 오후 11:22

class CBOOKS : public CRecordset
{
public:
	CBOOKS(CDatabase* pDatabase = NULL);
	DECLARE_DYNAMIC(CBOOKS)
...
// 버전 3.5 이상을 사용해야 합니다).
	...
	long	m_ID;
	CStringW	m_BOOK_ISBN;
	CStringW	m_BOOK_TITLE;
	CStringW	m_BOOK_AUTHOR;
	CStringW	m_BOOK_RENT_YN;
