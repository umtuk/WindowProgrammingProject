...
BEGIN_MESSAGE_MAP(CChatDlg, CDialogEx)
	...
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_MESSAGE(WM_ACCEPT_SOCKET, &CChatDlg::OnAcceptSocket)
	ON_MESSAGE(WM_CLIENT_MSG_RECV, &CChatDlg::OnClientMsgRecv)
	ON_MESSAGE(WM_CLIENT_CLOSE, &CChatDlg::OnClientClose)
END_MESSAGE_MAP()
...
afx_msg LRESULT CChatDlg::OnAcceptSocket(WPARAM wParam, LPARAM lParam)
{
	CString str;
...
afx_msg LRESULT CChatDlg::OnClientMsgRecv(WPARAM wParam, LPARAM lParam)
{
...
afx_msg LRESULT CChatDlg::OnClientClose(WPARAM wParam, LPARAM lParam)
{
